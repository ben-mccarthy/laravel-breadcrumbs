...
class ManagerTest extends TestCase {
	...
	public function setUp()
	{
		...
		$this->currentRoute = m::mock('IsmUk\Breadcrumbs\CurrentRoute');
		$this->generator    = m::mock('IsmUk\Breadcrumbs\Generator');
		$this->view         = m::mock('IsmUk\Breadcrumbs\View');
